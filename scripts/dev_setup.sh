#!/bin/bash
# This script sets up the environment for the XPeer build by installing necessary dependencies.
#
...
if [ ! -f Cargo.toml ]; then
	echo "Unknown location. Please run this from the xpeer repository. Abort."
	exit 1
fi
...
build XPeer Core. This includes:
