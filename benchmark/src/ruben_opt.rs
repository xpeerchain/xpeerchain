...
#[structopt(
    name = "RuBen",
    author = "XPeer",
    about = "RuBen (Ru)ns The XPeer (Ben)chmarker For You."
)]
pub struct Opt {
    ...
    /// xpeer_swarm's config file directory, which holds xpeer_node's config .toml file(s).
    ...
    /// Number of accounts to create in XPeer.
...
/// and return xpeer_swarm's configuration info as a tuple:
