...
use xpeer_wallet::wallet_library::WalletXPeerry;
use logger::prelude::*;
...
/// Benchmark library for XPeer Blockchain.
///
...
pub struct Benchmarker {
    ...
    /// Use WalletXPeerry to setup the benchmarking environment.
...
impl Benchmarker {
    ...
    /// while the xpeer swarm as a server keeping running.
    ...
    /// Assume Benchmarker is the ONLY active client in the xpeer network.
    ...
    /// Craft TXN request to mint receiver FREE_LUNCH xpeer coins.
    ...
    /// Estimated TXN throughput internal to xpeer = #TXN / t_commit, not measured by this API.
