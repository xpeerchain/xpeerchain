...
fn test_basic_invariants() {
    ...
    test_invariant(|node| postorder_to_inorder(inorder_to_postorder(node)) == node);
    ...
    test_invariant_non_leaf(|node| {
        inorder_to_postorder(left_child(node)) < inorder_to_postorder(node)
    });
    test_invariant_non_leaf(|node| {
        inorder_to_postorder(right_child(node)) < inorder_to_postorder(node)
    });

    test_invariant_non_leaf(|node| {
        inorder_to_postorder(right_child(node)) + 1 == inorder_to_postorder(node)
    });
