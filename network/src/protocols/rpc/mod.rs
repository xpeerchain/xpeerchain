...
//!
//! # SLURP: Simple XPeer Unary Rpc Protocol
//!
...
//!    around opaque blobs. Current xpeer rpc clients (consensus, mempool) mostly
//!    send protobuf enums around over a single rpc protocol,
//!    e.g., `/xpeer/consensus/rpc/0.1.0`.
//!
...
//!    wish to call, e.g., `/xpeer/mempool/rpc/0.1.0`.
...
pub struct InboundRpcRequest {
    /// Rpc method identifier, e.g., `/xpeer/consensus/rpc/0.1.0`. This is used
...
pub struct OutboundRpcRequest {
    /// Rpc method identifier, e.g., `/xpeer/consensus/rpc/0.1.0`. This is the
