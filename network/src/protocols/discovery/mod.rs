...
//! Protocol to discover network addresses of other peers on the XPeer network
//!
//! ## Implementation
//!
//! The discovery module is implemented as a stand-alone actor in the Network sub-system of the
//! XPeer stack. The actor participates in discovery by periodically sending its observed state of
...
pub const DISCOVERY_PROTOCOL_NAME: &[u8] = b"/xpeer/discovery/0.1.0";
