...
///
/// There is a 1-1 mapping between each interface provided here and a XPeerDB API. A method call on
/// this relays the query to the storage backend behind the scene which calls the corresponding
/// XPeerDB API. Both synchronized and asynchronized versions of the APIs are provided.
pub trait StorageRead: Send + Sync {
    /// See [`XPeerDB::update_to_latest_ledger`].
    ///
    /// [`XPeerDB::update_to_latest_ledger`]:
    /// ../xpeerdb/struct.XPeerDB.html#method.update_to_latest_ledger
    fn update_to_latest_ledger(
        &self,
        client_known_version: Version,
    ...
    /// See [`XPeerDB::update_to_latest_ledger`].
    ///
    /// [`XPeerDB::update_to_latest_ledger`]:../xpeerdb/struct.XPeerDB.html#method.
    ...
    /// See [`XPeerDB::get_transactions`].
    ///
    /// [`XPeerDB::get_transactions`]: ../xpeerdb/struct.XPeerDB.html#method.get_transactions
    fn get_transactions(
        &self,
        start_version: Version,
        batch_size: u64,
    ...
    /// See [`XPeerDB::get_account_state_with_proof_by_state_root`].
    ///
    /// [`XPeerDB::get_account_state_with_proof_by_state_root`]:
    /// ../xpeerdb/struct.XPeerDB.html#method.get_account_state_with_proof_by_state_root
    fn get_account_state_with_proof_by_state_root(
        &self,
        address: AccountAddress,
        state_root_hash: HashValue,
    ...
    /// See [`XPeerDB::get_executor_startup_info`].
    ///
    /// [`XPeerDB::get_executor_startup_info`]:
    /// ../xpeerdb/struct.XPeerDB.html#method.get_executor_startup_info
    fn get_executor_startup_info(&self) -> Result<Option<ExecutorStartupInfo>>;
...
///
/// There is a 1-1 mappings between each interface provided here and a XPeerDB API. A method call on
/// this relays the query to the storage backend behind the scene which calls the corresponding
/// XPeerDB API. Both synchronized and asynchronized versions of the APIs are provided.
pub trait StorageWrite: Send + Sync {
    /// See [`XPeerDB::save_transactions`].
    ///
    /// [`XPeerDB::save_transactions`]: ../xpeerdb/struct.XPeerDB.html#method.save_transactions
    fn save_transactions(
        &self,
        txns_to_commit: Vec<TransactionToCommit>,
        first_version: Version,
