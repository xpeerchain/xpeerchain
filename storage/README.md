...
entire set of data on the XPeer Blockchain, as well as the necessary data used
internally by XPeer Core.
...
The XPeer Blockchain can be viewed as a Merkle tree consisting of the following
components:

![data](https://developers.xpeer.org/docs/assets/data.png)
...
The core module that implements the main functionalities is called *XPeerDB*.
...
```
    storage
          ...
          └── xpeerdb          # Implementation of XPeerDB.
          └── schemadb         # Schematized wrapper on top of RocksDB.
          └── scratchpad       # In-memory representation of XPeer core data structures used by execution.
