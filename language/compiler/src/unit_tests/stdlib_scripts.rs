...
#[test]
fn compile_xpeer_coin() {
    let code = include_str!("../../../stdlib/modules/xpeer_coin.mvir");
    let _compiled_module = compile_module_string(&code).unwrap();
}
...
fn compile_account_module() {
    ...
    let coin_code = include_str!("../../../stdlib/modules/xpeer_coin.mvir");
    let account_code = include_str!("../../../stdlib/modules/xpeer_account.mvir");
