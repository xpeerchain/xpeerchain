...
lazy_static! {
    ...
    pub static ref ACCOUNT_MODULE: ModuleId =
        { ModuleId::new(account_config::core_code_address(), "XPeerAccount".to_string()) };
    /// The ModuleId for where XPeerCoin module is being stored.
    pub static ref COIN_MODULE: ModuleId =
        { ModuleId::new(account_config::core_code_address(), "XPeerCoin".to_string()) };
}
