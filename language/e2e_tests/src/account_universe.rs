...
//! A model to test properties of common XPeer transactions.
//!
//! The structs and functions in this module together form a simplified *model* of how common XPeer
...
pub fn txn_one_account_result(
    ...
    // The transactions set the gas cost to 1 microxpeer.
